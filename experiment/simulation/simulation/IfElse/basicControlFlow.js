...
window.view = {
  ...
  activateEvents: function () {
    this.addChangeEvent("loopList", function () {
      view.showExecutionSection();
    });
  ...
  changeFlagValue: function (id1, id2, value) {
    // Set both label and value for the correct flag
    if (id1 === "flagValue1") {
  ...
  validationInput: function () {
    ...
    if (
      this.selectedLoop.id !== "ifElseList" &&
      this.selectedLoop.id !== "ifElseIfList"
    ) {
  ...
  executionOfIfElse: function () {
    ...
    this.nextOfnextSiblingElement = this.getNextSiblingElement(
      this.nextSiblingElement,
    );
    if (
      this.nextSiblingElement.id === "codeContentIfElse23Id" ||
      this.nextSiblingElement.id === "codeContentIfElse27Id"
    ) {
      this.codeExecutionWithColourAndId("codeContentIfElse28Id");
    } else {
      if (
        this.nextSiblingElement.id === "codeContentIfElse2Id" ||
        this.nextSiblingElement.id === "codeContentIfElse3Id"
      ) {
        if (this.nextSiblingElement.id === "codeContentIfElse2Id")
          this.setFlagText();
        else this.setFlagValue();
      }
      if (
        this.nextSiblingElement.id === "codeContentIfElse4Id" ||
        this.nextOfnextSiblingElement.id === "codeContentIfElse6Id"
      ) {
        ...
        else this.codeExecutionWithColourAndId("codeContentIfElse8Id");
      }
      if (
        this.nextOfnextSiblingElement.id === "codeContentIfElse8Id" ||
        this.nextOfnextSiblingElement.id === "codeContentIfElse10Id"
      ) {
        ...
        else this.codeExecutionWithColourAndId("codeContentIfElse12Id");
      }
      if (
        this.nextOfnextSiblingElement.id === "codeContentIfElse12Id" ||
        this.nextOfnextSiblingElement.id === "codeContentIfElse14Id"
      ) {
        ...
        else this.codeExecutionWithColourAndId("codeContentIfElse16Id");
      }
      if (
        this.nextOfnextSiblingElement.id === "codeContentIfElse16Id" ||
        this.nextOfnextSiblingElement.id === "codeContentIfElse18Id"
      ) {
        ...
        else this.codeExecutionWithColourAndId("codeContentIfElse20Id");
      }
      if (
        this.nextOfnextSiblingElement.id === "codeContentIfElse20Id" ||
        this.nextOfnextSiblingElement.id === "codeContentIfElse22Id"
      ) {
  ...
  executionOfIfElseIfElse: function () {
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf3bId" &&
      model.valueOfX < 75
    )
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf3dId" &&
      model.valueOfX > 275
    )
      this.changeFlagValue("flagValue1", "codeContentIfElseIf5Id", "0");
    if (
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf7bId" &&
      model.valueOfY < 75
    )
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf7dId" &&
      model.valueOfY > 325
    )
      this.changeFlagValue("flagValue1", "codeContentIfElseIf9Id", "0");
    if (
    ...
    if (
      (this.nextSiblingElement.id === "codeContentIfElseIf12Id" ||
        this.nextSiblingElement.id === "codeContentIfElseIf14Id" ||
        this.nextSiblingElement.id === "codeContentIfElseIf16Id") &&
      75 <= model.valueOfX &&
      model.valueOfX <= 275 &&
      75 <= model.valueOfY &&
      model.valueOfY <= 325
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf6Id" ||
      this.nextSiblingElement.id === "codeContentIfElseIf10Id"
    )
    ...
    if (
      this.nextSiblingElement.id === "codeContentIfElseIf18Id" ||
      this.nextSiblingElement.id === "codeContentIfElseIf22Id"
    ) {
